...
const en = {
    ...
    FeedbackDescription: "You can request a new feature, report something that isn't working, suggest an improvement, or just share your opinion about the app.",
...
const ru: typeof en = {
    ...
    FeedbackDescription: "Вы можете запросить новую функцию, сообщить о проблеме, предложить улучшение или просто поделиться своим мнением о приложении.",
    ...
    AdminUserDetailTitle: "Информация о пользователе",
    AdminColRole: "Роль",
